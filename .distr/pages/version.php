...
$description = isset($description) ? $description : 'Музыкальная школа БАСТА × СИНЕРГИЯ — курсы вокала, рэпа, звукорежиссуры, диджеинга и музыкального продюсирования. Узнайте стоимость обучения и запишитесь на курс';
