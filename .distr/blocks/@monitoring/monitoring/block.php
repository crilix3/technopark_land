        ...
        <div class="monitoring__content-text">
            <div class="monitoring__content-container">
                <div class="monitoring__content-text_flex">
                    <h1 class="monitoring__content-text_title">КОМПЛЕКСНЫЙ МОНИТОРИНГ ЗВУЧАНИЯ В СТУДИИ</h1>
                    <p class="monitoring__content-text_subtitle">Контроль звучания в ближнем, среднем и дальнем поле: кристальная чистота в любой зоне студии — обеспечиваем сбалансированный звук на всех этапах работы, чтобы каждый нюанс был слышен именно так, как задумано</p>
                </div>
            </div>
