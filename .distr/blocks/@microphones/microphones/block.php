        ...
        <div class="monitoring__content-text">
            <div class="monitoring__content-container">
                <div class="monitoring__content-text_flex">
                    <h1 class="monitoring__content-text_title">ПОДБОР МИКРОФОНОВ ПОД ЛЮБЫЕ ЗАДАЧИ</h1>
                    <p class="monitoring__content-text_subtitle">Широкий выбор микрофонов для записи вокала, инструментов и атмосфер: точное звучание под любую задачу — от деликатной передачи нюансов голоса до уверенной фиксации мощных инструментов и атмосферных эффектов</p>
                </div>
            </div>
