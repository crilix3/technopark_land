        ...
        <div class="monitoring__content-text">
            <div class="monitoring__content-container">
                <div class="monitoring__content-text_flex">
                    <h1 class="monitoring__content-text_title">НАДЁЖНОЕ АУДИО ЯДРО И ТОЧНЫЙ КОНТРОЛЬ СИГНАЛА</h1>
                    <p class="monitoring__content-text_subtitle">Профессиональная маршрутизация, конвертация и контроль сигнала: безупречная передача без искажений — гарантируем стабильную работу всей сигнальной цепи и полный контроль над каждым этапом обработки звука</p>
                </div>
            </div>
